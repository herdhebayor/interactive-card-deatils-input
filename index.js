...
submitBtn.addEventListener("click",  function validateForm(e){
      ...
      if(name.value == ""){
        ...
        document.querySelector(".exp").append(errorCont)
        ...
        errorCont.innerHTML = "can't be blank"
        cvxNum.parentElement.append(errorCont)
